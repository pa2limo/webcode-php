<footer>
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="widget">
					...
					<ul class="link-list">
						<li><a href="<?php echo URL; ?>/legalterms/index.php" target="_blank">Privacy Policy</a></li>
						<li><a href="<?php echo URL; ?>/blogs/index.php" target="_blank">Blog Post - Web Technology</a></li>
                        <li><a href="<?php echo URL; ?>/snippets/index.php" target="_blank">Snippet - PHP and Bootstrap 3</a></li>
                        <li><a href="<?php echo URL; ?>/tutors/index.php" target="_blank">Tutorial</a></li>
                        <li><a href="<?php echo URL; ?>/webtemplates/index.php" target="_blank">Web Templates</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="row">
				<div class="col-lg-8">
					<div class="copyright">
						<p><span class="koneng">&copy; WEBCODE 2014</span> All right reserved. By 
							<a href="http://webcode.or.id" target="_blank"> Pa2limo</a>
						</p>
					</div>
				</div>
				<div class="col-lg-4">
